 ...
 * a datacenter with six hosts and run two
 ...
 */
public class CloudSim_DataCenter_Setup {
	...
	public static void main(String[] args) {
		...
		Log.printLine("Starting CloudSim_DataCenter_Setup...");
		...
		try {
			...
			vmid++;
			Vm vm6 = new Vm(vmid, brokerId, mips * 2, pesNumber, ram, bw, size, vmm, new CloudletSchedulerTimeShared());
			
			vmid++;
			Vm vm7 = new Vm(vmid, brokerId, mips, pesNumber, ram, bw, size, vmm, new CloudletSchedulerTimeShared());
			
			vmid++;
			Vm vm8 = new Vm(vmid, brokerId, mips * 2, pesNumber, ram, bw, size, vmm, new CloudletSchedulerTimeShared());
			
			vmid++;
			Vm vm9 = new Vm(vmid, brokerId, mips, pesNumber, ram, bw, size, vmm, new CloudletSchedulerTimeShared());
			
			vmid++;
			Vm vm10 = new Vm(vmid, brokerId, mips * 2, pesNumber, ram, bw, size, vmm, new CloudletSchedulerTimeShared());
			
			vmid++;
			Vm vm11 = new Vm(vmid, brokerId, mips, pesNumber, ram, bw, size, vmm, new CloudletSchedulerTimeShared());
			
			vmid++;
			Vm vm12 = new Vm(vmid, brokerId, mips * 2, pesNumber, ram, bw, size, vmm, new CloudletSchedulerTimeShared());
			
			vmid++;
			Vm vm13 = new Vm(vmid, brokerId, mips, pesNumber, ram, bw, size, vmm, new CloudletSchedulerTimeShared());
			
			vmid++;
			Vm vm14 = new Vm(vmid, brokerId, mips * 2, pesNumber, ram, bw, size, vmm, new CloudletSchedulerTimeShared());
			...
			Log.printLine("CloudSim_DataCenter_Setup finished!");
		}
		catch (Exception e) {
			e.printStackTrace();
